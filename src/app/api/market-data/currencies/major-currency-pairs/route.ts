...
const TICKERS = ['O:EURUSD', 'O:USDJPY', 'O:GBDUSD', 'O:USDCHF', 'O:AUDUSD', 'O:USDCAD', 'O:NZDUSD', 'O:EURJPY', 'O:GBPJPY', 'O:EURGBP', 'O:EURCHF', 'O:AUDJPY'];
...
export async function GET() {
  ...
  'O:AUDJPY': 'AUD/JPY',     
    ...
    return NextResponse.json(currencies.sort((a: CurrencyData, b: CurrencyData) => b.oneYearChange - a.oneYearChange).slice(0, 12));
  } catch (error: any) {
