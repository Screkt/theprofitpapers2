...
const TICKERS = ['VT', 'VEU', 'VWO', 'EMJ', 'VGK', 'FXI', 'INDA', 'EWZ'];
...
export async function GET() {
  ...
  try {
    ...
    const equities: GlobalEquityData[] = TICKERS.map(ticker => {
    ...
    return NextResponse.json(equities.sort((a: GlobalEquityData, b: GlobalEquityData) => b.oneYearChange - a.oneYearChange).slice(0, 8));
  } catch (error: any) {
    console.error('Global Equity fetch error:', error);
    const mockEquities: GlobalEquityData[] = [
      { name: 'Total World', ticker: 'VT', price: 120.5, todayChange: 0.35, fiveDayChange: 2.15, oneMonthChange: 4.20, threeMonthChange: 6.1, ytdChange: 18.50, oneYearChange: 22.30, threeYearChange: 35.2, fiveYearChange: 75.8, tenYearChange: 160.4, dailyRange: "Low $119.80 - High $121.20", oneYearRange: "Low $98.50 - High $122.10" },
      { name: 'Dev. ex-US', ticker: 'VEU', price: 65.2, todayChange: 0.28, fiveDayChange: 1.85, oneMonthChange: 3.45, threeMonthChange: 5.0, ytdChange: 14.20, oneYearChange: 16.80, threeYearChange: 25.1, fiveYearChange: 55.3, tenYearChange: 110.7, dailyRange: "Low $64.90 - High $65.70", oneYearRange: "Low $55.20 - High $66.00" },
      { name: 'Emerging Mkts', ticker: 'VWO', price: 48.7, todayChange: 0.42, fiveDayChange: 2.30, oneMonthChange: 5.10, threeMonthChange: 7.2, ytdChange: 12.40, oneYearChange: 15.60, threeYearChange: 22.4, fiveYearChange: 45.9, tenYearChange: 90.2, dailyRange: "Low $48.30 - High $49.10", oneYearRange: "Low $40.80 - High $49.50" },
      { name: 'Japan', ticker: 'EWJ', price: 72.4, todayChange: -0.15, fiveDayChange: 0.95, oneMonthChange: 2.80, threeMonthChange: 4.3, ytdChange: 10.80, oneYearChange: 13.20, threeYearChange: 18.7, fiveYearChange: 40.1, tenYearChange: 75.6, dailyRange: "Low $72.10 - High $72.80", oneYearRange: "Low $62.50 - High $73.20" },
      { name: 'Europe', ticker: 'VGK', price: 68.9, todayChange: 0.22, fiveDayChange: 1.40, oneMonthChange: 3.10, threeMonthChange: 4.8, ytdChange: 11.50, oneYearChange: 14.00, threeYearChange: 20.3, fiveYearChange: 48.2, tenYearChange: 95.4, dailyRange: "Low $68.60 - High $69.30", oneYearRange: "Low $58.40 - High $69.80" },
      { name: 'China', ticker: 'FXI', price: 35.1, todayChange: -0.48, fiveDayChange: -1.20, oneMonthChange: -0.50, threeMonthChange: 1.2, ytdChange: 5.30, oneYearChange: 7.80, threeYearChange: 10.5, fiveYearChange: 25.7, tenYearChange: 50.1, dailyRange: "Low $34.90 - High $35.40", oneYearRange: "Low $30.20 - High $36.00" },
      { name: 'India', ticker: 'INDA', price: 58.3, todayChange: 0.55, fiveDayChange: 3.10, oneMonthChange: 6.40, threeMonthChange: 9.5, ytdChange: 20.10, oneYearChange: 24.70, threeYearChange: 38.2, fiveYearChange: 85.4, tenYearChange: 170.8, dailyRange: "Low $57.90 - High $58.80", oneYearRange: "Low $46.50 - High $59.20" },
      { name: 'Brazil', ticker: 'EWZ', price: 28.6, todayChange: -0.32, fiveDayChange: 0.60, oneMonthChange: 1.90, threeMonthChange: 3.1, ytdChange: 8.20, oneYearChange: 10.40, threeYearChange: 14.8, fiveYearChange: 32.5, tenYearChange: 65.3, dailyRange: "Low $28.40 - High $28.90", oneYearRange: "Low $24.10 - High $29.30" },
    ];
