...
type SortConfig = { key: keyof GlobalEquityData | null; direction: 'asc' | 'desc' };
type HandleSort = (key: keyof GlobalEquityData) => void;

const CUSTOM_GRID_COLUMNS = "grid-cols-[260px_80px_90px_90px_90px_90px_90px_90px_90px_90px_200px_200px]";

const mockGlobalEquities: GlobalEquityData[] = [
    { name: 'Total World', ticker: 'VT', price: 120.5, todayChange: 0.35, fiveDayChange: 2.15, oneMonthChange: 4.20, threeMonthChange: 6.1, ytdChange: 18.50, oneYearChange: 22.30, threeYearChange: 35.2, fiveYearChange: 75.8, tenYearChange: 160.4, dailyRange: "119.80 • 121.20", oneYearRange: "98.50 • 122.10" },
    { name: 'Dev. ex-US', ticker: 'VEU', price: 65.2, todayChange: 0.28, fiveDayChange: 1.85, oneMonthChange: 3.45, threeMonthChange: 5.0, ytdChange: 14.20, oneYearChange: 16.80, threeYearChange: 25.1, fiveYearChange: 55.3, tenYearChange: 110.7, dailyRange: "64.90 • 65.70", oneYearRange: "55.20 • 66.00" },
    { name: 'Emerging Mkts', ticker: 'VWO', price: 48.7, todayChange: 0.42, fiveDayChange: 2.30, oneMonthChange: 5.10, threeMonthChange: 7.2, ytdChange: 12.40, oneYearChange: 15.60, threeYearChange: 22.4, fiveYearChange: 45.9, tenYearChange: 90.2, dailyRange: "48.30 • 49.10", oneYearRange: "40.80 • 49.50" },
    { name: 'Japan', ticker: 'EWJ', price: 72.4, todayChange: -0.15, fiveDayChange: 0.95, oneMonthChange: 2.80, threeMonthChange: 4.3, ytdChange: 10.80, oneYearChange: 13.20, threeYearChange: 18.7, fiveYearChange: 40.1, tenYearChange: 75.6, dailyRange: "72.10 • 72.80", oneYearRange: "62.50 • 73.20" },
    { name: 'Europe', ticker: 'VGK', price: 68.9, todayChange: 0.22, fiveDayChange: 1.40, oneMonthChange: 3.10, threeMonthChange: 4.8, ytdChange: 11.50, oneYearChange: 14.00, threeYearChange: 20.3, fiveYearChange: 48.2, tenYearChange: 95.4, dailyRange: "68.60 • 69.30", oneYearRange: "58.40 • 69.80" },
    { name: 'China', ticker: 'FXI', price: 35.1, todayChange: -0.48, fiveDayChange: -1.20, oneMonthChange: -0.50, threeMonthChange: 1.2, ytdChange: 5.30, oneYearChange: 7.80, threeYearChange: 10.5, fiveYearChange: 25.7, tenYearChange: 50.1, dailyRange: "34.90 • 35.40", oneYearRange: "30.20 • 36.00" },
    { name: 'India', ticker: 'INDA', price: 58.3, todayChange: 0.55, fiveDayChange: 3.10, oneMonthChange: 6.40, threeMonthChange: 9.5, ytdChange: 20.10, oneYearChange: 24.70, threeYearChange: 38.2, fiveYearChange: 85.4, tenYearChange: 170.8, dailyRange: "57.90 • 58.80", oneYearRange: "46.50 • 59.20" },
    { name: 'Brazil', ticker: 'EWZ', price: 28.6, todayChange: -0.32, fiveDayChange: 0.60, oneMonthChange: 1.90, threeMonthChange: 3.1, ytdChange: 8.20, oneYearChange: 10.40, threeYearChange: 14.8, fiveYearChange: 32.5, tenYearChange: 65.3, dailyRange: "28.40 • 28.90", oneYearRange: "24.10 • 29.30" },
];
...
const EquityRow: React.FC<GlobalEquityData & { isLast?: boolean }> = ({
...
const App: React.FC = () => {
    const [equities, setEquities] = useState<GlobalEquityData[]>([]);
    ...
    const fetchEquities = async () => {
        ...
        try {
            ...
            const data = mockGlobalEquities;

            if (Array.isArray(data) && data.length > 0) {
                setEquities(data);
            } else {
                setError('No data returned from API');
                setEquities(mockGlobalEquities);
            }
        } catch (err: any) {
    ...
    const handleSort: HandleSort = (key: keyof GlobalEquityData) => {
    ...
    const scrollTable = (direction: 'left' | 'right') => {
        ...
        const Header = ({ sortConfig, handleSort }: { sortConfig: SortConfig; handleSort: HandleSort }) => {        
            const getSortIndicator = (key: keyof GlobalEquityData) => {
