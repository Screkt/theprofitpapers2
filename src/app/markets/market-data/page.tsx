...
import USEquityGrid from '@/src/app/components/market-data/key-market-data/USEquityGrid';
import USSectorsGrid from '@/src/app/components/market-data/key-market-data/USSectorGrid';
import GlobalEquityMarkets from '@/src/app/components/market-data/key-market-data/GlobalEquityMarkets';
import CountryEquityMarkets from '@/src/app/components/market-data/key-market-data/ByCountry';
import USBonds from '@/src/app/components/market-data/key-market-data/USBonds';
import Currencies from '@/src/app/components/market-data/key-market-data/Currencies';
    ...
    <aside className="bg-white flex flex-col shrink-0 p-4 mr-4">
      <div className="w-full bg-white">
        <div className="w-full">
          <h1 className="text-gray-800 text-2xl mb-2 text-center font-serif">
            Market Data
          </h1>
        </div>
