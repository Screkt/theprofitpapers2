...
import USTreasuries from '@/src/app/components/market-data/bond-markets/USTreasuries';
import USCorporateBonds from '@/src/app/components/market-data/bond-markets/CorporateBonds';
import MunicipalBonds from '@/src/app/components/market-data/bond-markets/MunicipalBonds';
import GlobalSovereignBonds from '@/src/app/components/market-data/bond-markets/GlobalSovereignBonds';
const BondDuration = dynamic(
  () => import('@/src/app/components/market-data/bond-markets/BondDuration'),
  { ssr: false }
);
  ...
  <div className="flex min-h-screen bg-gray-100 py-4 px-4">
    <aside className="bg-white flex flex-col shrink-0 p-4 mr-4">
      ...
      <main className="flex-1 overflow-y-auto w-full">
        ...
        <div className="bg-white p-4 mt-4">
          <h3 className="text-black text-2xl font-serif">
            Global Soverign Bonds
          </h3>
          <div>
            <GlobalSovereignBonds />
          </div>
        </div>
        <div className="bg-white p-4 mt-4">
          <h3 className="text-black text-2xl font-serif">
            Bond Duration & Curve Analysis
          </h3>
          <div>
            <BondDuration />
          </div>
